...
class MarkdownReporter(BaseReporter):
    ...
    def generate_report(self, output_path: str) -> None:
        ...
        if self.total_lines > 0:
            ...
            content.append(f"| &nbsp;&nbsp;├─ Code Lines | {self.total_code_lines} | {code_percent} |")
            content.append(f"| &nbsp;&nbsp;├─ Comment Lines | {self.total_comment_lines} | {comment_percent} |")
            content.append(f"| &nbsp;&nbsp;└─ Blank Lines | {self.total_blank_lines} | {blank_percent} |")
        ...
        for language, metrics in self.metrics_by_language.items():
            ...
            if language == 'Python':
                ...
                content.append(f"| List Comprehensions | {getattr(metrics, 'list_comprehensions', 0)} |")
